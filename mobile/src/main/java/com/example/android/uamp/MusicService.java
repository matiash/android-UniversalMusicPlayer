...
/**
 * This class provides a MediaBrowserCompat through a service. It exposes the media library to a browsing
 * client, through the onGetRoot and onLoadChildren methods. It also creates a MediaSessionCompat and
 * exposes it through its MediaSessionCompat.Token, which allows the client to create a MediaControllerCompat
 ...
 * <li> In onCreate, start a new {@link android.support.v4.media.session.MediaSessionCompat} and notify its parent
 *      with the session's token {@link android.service.media.MediaBrowserService#setSessionToken};
 *
 * <li> Set a callback on the
 *      {@link android.support.v4.media.session.MediaSessionCompat#setCallback(android.support.v4.media.session.MediaSessionCompat.Callback)}.
 ...
 *      {@link android.support.v4.media.session.MediaSessionCompat#setPlaybackState(android.support.v4.media.session.PlaybackStateCompat)}
 *      {@link android.support.v4.media.session.MediaSessionCompat#setMetadata(android.support.v4.media.MediaMetadataCompat)} and
 *      {@link android.support.v4.media.session.MediaSessionCompat#setQueue(java.util.List)})
 *
...
public class MusicService extends MediaBrowserServiceCompat implements Playback.Callback {
    ...
    // Extra on MediaSessionCompat that contains the Cast device name currently connected to
    ...
    private final VideoCastConsumerImpl mCastConsumer = new VideoCastConsumerImpl() {
        ...
        public void onApplicationConnected(ApplicationMetadata appMetadata, String sessionId,
                                           boolean wasLaunched) {
            // In case we are casting, send the device name as an extra on MediaSessionCompat metadata.
    ...
    public void onCreate() {
        ...
        mSession = new MediaSessionCompat(this, "MusicService", mediaButtonReceiver, mediaPendingIntent);
    ...
    private final class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onPlayFromMediaId(String mediaId, Bundle extras) {
            ...
            // MediaBrowserCompat, and is actually a "hierarchy-aware mediaID": a concatenation of
            // the hierarchy in MediaBrowserCompat and the actual unique musicID. This is necessary
